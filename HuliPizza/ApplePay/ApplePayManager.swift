...
//  ANDPizza
//
//  Created by Emil Vaklinov on 25/07/2021.
//
...
final class ApplePayManager: NSObject {
    ...
    private lazy var billingContact: PKContact = {
        ...
        namecomponents.familyName = "Vaklinov"
        contact.emailAddress = "emil.vaklinov@and.digital"
