...
{"items":[
    ...
    {"id":1,"name":"Hamilton Chicken","latitude":51.513433,"longitude":-0.136267,"history":"Reinvented by ANDi Emil during pizza Hamilton club day :). Originally made in Hawaii on the island of Oahu, some friends got together to make pizzas, island style. They were often hungry after a good wave or two and wanted somewhere good to go that didn't look and taste mainland, especially Canadian. They took street foods and traditional pizzas from around the world to create a new pizza experience. In Hawaiian, hull means turn, which is a reference to the manual barbecue and rotisserie method of cooking huli chicken in teriyaki sauce blends."},
